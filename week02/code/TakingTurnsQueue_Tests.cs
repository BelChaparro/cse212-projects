...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue was inserting the persons at the beginning of the queue instead of the end.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The Enqueue did not consider people with infinite turns (<= 0).
    ...
    // Defect(s) Found: The Enqueue did not contemplate negative numbers as infinite turns.
